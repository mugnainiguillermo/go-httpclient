...
```bash
# Go Modules
require github.com/mugnainiguillermo/go-httpclient
```
...
```go
import "github.com/mugnainiguillermo/go-httpclient/gohttp"
```
...
```go
import "github.com/mugnainiguillermo/go-httpclient/gohttp_mock"
```
